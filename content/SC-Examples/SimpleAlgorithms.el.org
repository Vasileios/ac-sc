...
~pattP = Prand((0..14)++(13..0)++[\rest], inf);

~pattPm  = Pseq((60..80)++(79..60)++[\rest], 8);

~pattD = 0.25;

Pbind(
	\instrument, \synth01,
	\freq, ~pattPm, //try also ~pattP
	\dur, ~pattD,
	\mod, Pseq((40..20000), 8),//change the values here as well
	\ind, Pseq((30..10000), 8),//and here
...
Pdef(\first_mov1, Pbind(\scale, ~scaleS,
	\degree, ~pattP,
	\dur, ~pattD)).play;
...
Pdef(\first_mov2, Pbind(\scale, ~scaleS,
	\degree, ~pattP,
	\dur, ~pattD2)).play;
