...
Objective: Create data, collect and amp to the arguments of the synth
*/

//Collect data as stream (array)
...
Pbind(\instrument, \tgrain, \dur, Pseq(e), \trate, Pseq(e), \rate, 1, \amp, 1, \bufdur, Pseq(e.sqrt)).play;
