...
Objective: Create two sounds one after the other then free one them (probability), wait a couple of sceonds to free also the remain sounds (probability). (Rolling a Dice)
*/
