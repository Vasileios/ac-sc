...
/*From Collins Modulation Synthesis Examples
...
Always possitive (0, 1)
SinOsc.ar(440, 0, 0.4) (-0.5, 0.5) bipolar
SinOsc.ar(440, 0.5, 0.4) (0, 1) unipolar
*/
(
{
var carrier, modulator, carrfreq, modfreq;
...
//Create a window with sliders to control the frequency modulation
