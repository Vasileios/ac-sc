...
s = Server.internal;
s.boot;
//In the Stethoscope's GUI up right menu choose X/Y ("Lissajous curve" frequencies of the vertical and horizontal sinusoidal inputs, respectively) (left and right channels).
