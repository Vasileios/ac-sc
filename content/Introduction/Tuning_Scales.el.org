...
αυτή τη σειράό κυριαρχούν οι οκτάβες (2/1), οι
πέμπτες (3/2) και οι τέταρτες (4/3). Η πέμπτη και η τέταρτη αν
συνδυάστουν μεταξύ τους θα φτιάξουν την οκτάβα (3/2*4/3=2/1), και αν
...
[[https://www.scribd.com/doc/147969892/Anthony-Ashton-Harmonograph-A-Visual-Guide-to-the-Mathematics-of-Music-cleaned][Harmonograph-AVisual Guide to The Mathematics of Music]]
...
s = Server.internal;
s.boot;
//choose X/Y in the up right menu


{SinOsc.ar([440, 440*81/64, 440*3/2])}.scope // pythagorean tuning: see leimma halftome of 256/243 between its major third (81/64) and the perfect fourth (4/3) (E to F and B to C)
