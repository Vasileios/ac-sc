...
{SinOsc.ar([440, 440*81/64, 440*3/2])}.scope // pythagorean tuning: see leimma halftome of 256/243 between its major third (81/64) and the perfect fourth (4/3) as well as between major seventh and the dominant (E to F and B to C)
